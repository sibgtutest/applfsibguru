...
/**
 * PublicController implements the CRUD actions for Profile model.
 */
class PublicController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $query = Profile::find()->where(['rule' => $userid, 'section' => 'Public']);
    ...
    public function actionView($id)
    {
        ...
        $file = \Yii::$app->params['pathUploads'] . $i . '/' . 'Public_' . $filename;
    ...
    public function actionCreate()
    {
        ...
        if(Yii::$app->request->post()) {
             ...
             if ($model->validate()) {
                  ...
                  $model->filename->saveAs( $path . 'Public_' . $filename);
                  $model->savePublic($filename);
    ...
    public function actionDelete($id)
    {
        $userid= \Yii::$app->user->identity->id;
        $path = \Yii::$app->params['pathUploads'] . $userid . '/';
        unlink( $path . 'Public_' . $this->findModel($id)->key_profile );
